  ...
  <div class="space-y-6">
    <section class="space-y-2">
      ...
      <p class="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <em>fair witness methodology</em>, the best attestations are specific, dated, and point to
        verifiable evidence. They're signed by a dedicated attestation key (not your inception key)
        so that claims can be rotated without affecting your core identity.
      </p>
    </section>
    ...
    <template v-if="activeDoc">
      ...
      <div class="rounded-lg border border-gray-200 dark:border-gray-800 p-4 space-y-3">
        ...
        <div v-if="hasAttestationKey" class="flex items-center gap-2 text-sm">
          ...
          <span
            >Registered in your XID with <code class="text-xs">Sign</code>-only permission.</span
          >
        </div>
        <UButton
          v-else
          label="Create + register attestation key"
          color="primary"
        ...
        >
          <div class="flex items-center justify-between gap-2">
            <div class="flex items-center gap-2 flex-wrap">
              ...
              <UBadge v-if="a.supersedesId" color="info" size="xs" variant="subtle"
                >supersedes</UBadge
              >
              <UBadge v-if="a.supersededBy" color="neutral" size="xs" variant="subtle"
                >superseded</UBadge
              >
              <UBadge v-if="a.retracted" color="warning" size="xs" variant="subtle"
                >retraction</UBadge
              >
              <UBadge
      ...
      <div class="rounded-lg border border-gray-200 dark:border-gray-800 p-4 space-y-3">
        ...
        <p class="text-xs text-gray-500">
          Re-verify the inception signature now that you've added an attestation key, then publish
          this edition and advance the provenance mark for the next one.
        </p>
        <div class="flex items-center gap-2 flex-wrap">
          <UButton
